	...
	return (
		...
		>
			<div className='bg-white dark:bg-slate-900 rounded-lg shadow-2xl overflow-hidden border-2 border-slate-200 dark:border-slate-700'>
				...
				<div className='bg-linear-to-r from-slate-900 to-slate-800 dark:from-slate-800 dark:to-slate-900 px-6 sm:px-8 py-6 sm:py-8'>
				...
				<div className='px-6 sm:px-8 py-6 sm:py-8'>
					<p className='text-slate-600 dark:text-slate-400 text-base sm:text-lg mb-6'>
						Registration for the Random Selection Draw has ended.
						Remaining tickets will be available for purchase
						starting:
					</p>
					...
					>
						<div className='flex items-start gap-3'>
							<Clock className='w-5 h-5 sm:w-6 sm:h-6 text-amber-600 dark:text-amber-400 shrink-0 mt-1' />
							<div>
					...
					>
						<div className='flex items-start gap-3'>
							<CheckCircle2 className='w-5 h-5 sm:w-6 sm:h-6 text-green-600 dark:text-green-400 shrink-0 mt-1' />
							<div>
								...
								<p className='text-green-800 dark:text-green-200 text-sm sm:text-base mt-1'>
									Check your email for updates on your
									selected matches
								</p>
							</div>
						</div>
